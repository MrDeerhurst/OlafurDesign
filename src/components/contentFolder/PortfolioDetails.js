...
export const PorfolioProjectsList = [
  ...
  // 3D Bottom Trawl Simulation
  {
    ...
    shortDescription:
      "Simulation of a new type of bottom fising trawl that uses lasers instead of metal rakes that scrape the bottom and destroy the ocean floor.",
  ...
  // VR Industry Training Research
  {
    ...
    myRoleExpanded:
      "Designed and implemented the VR user experience, led research, and translated findings into actionable design insights for immersive training applications.",
    product:
      "“Moving Air” – a VR training simulation and comparative study conducted for the metals industry as a master’s thesis project",
  ...
  // UX Strategist & Developer at Advania
  {
    ...
    shortDescription:
      "Redesigned how UX was practiced by introducing Figma into a developer-heavy workflow while also getting hands-on fixing broken code, modernizing legacy systems, and improving frontend experiences in Vue.js.",
    myRole: "UX Strategist & Developer",
    myRoleExpanded:
      "Led UX adoption and contributed hands-on development fixes across critical systems.",
  ...
  // Designing and developing a product impact website for DTE
  {
    ...
    shortDescription:
      "Redesigned and rebuilt a production impact calculator for DTE, transforming a friction-heavy experience into a streamlined, interactive tool built in Figma and React.",
    myRole: "UI/UX Designer & Frontend Developer",
    myRoleExpanded:
      "Led the UI/UX redesign and co-developed the frontend with a focus on translating design logic into interactive features.",
    product:
      "Impact calculator website for DTE – a company serving the aluminum production industry",
  ...
  // Enhancing the Customer Portal at the Icelandic Student Loan Fund
  {
    ...
    shortDescription:
      "Redesigned and helped develop key features of a national self-service portal to prevent errors, improve transparency, and reduce friction resulting in better compliance, fewer customer issues, and a more intuitive user experience.",
    myRole: "UX Developer & Product Tester",
    myRoleExpanded:
      "Designed and validated user flows, prototyped in Figma, and collaborated with developers to implement changes that addressed usability, support, and compliance.",
